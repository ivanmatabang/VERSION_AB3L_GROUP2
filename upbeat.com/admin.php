...
<html>
	...
	<body>
			...
			<?php
				...
				else
				{
					echo "<ul id = 'adminaccount'>
						...
						<li><a class = 'link' href = 'viewinventory.php?start=0&page=1'>View Inventory</a></li>
					</ul>";
				}
			?>
		...
		<div id = 'maincontent'>
			...
			<div id = 'slideshow'>
				<img id = 'image1' class = 'image' src = 'IMAGES/1.jpg'></img>
				<img id = 'image2' class = 'image' src = 'IMAGES/2.jpg'></img>
				<img id = 'image3' class = 'image' src = 'IMAGES/3.png'></img>
			</div>
